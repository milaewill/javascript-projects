...
if (fuelLevel > 20000 && engineTemperature <= 2500) {
    ...
    console.log("Check fuel fuelLevel. Engines hot.");
} else if (fuelLevel < 1000 || engineIndicatorLight === 'red blinking') {
...
// then the shuttle should only launch if the fuel and engine check are OK. If commandOverride is true, then 
//the shuttle will launch regardless of the fuel and engine status.

let commandOveride = false

/* 6) b) Code the following if/else check:
If fuelLevel is above 20000 AND engineIndicatorLight is NOT red blinking OR commandOverride is true print
 "Cleared to launch!" Else print "Launch scrubbed!" */
