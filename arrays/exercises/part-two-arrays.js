...
cargoHold[5] = "slinky", "space tether";
...
//4) Unlike pop and shift, push and unshift require arguments inside the (). Add the items 1138
// and ‘20 meters’ to the the array - the number at the start and the string at the end. Print 
...
console.log(`The array, ${cargoHold} has a final length of ${cargoHold.length}.`)